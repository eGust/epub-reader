          ...
          <Grid.Column width={6}>
            <Form.Field>
              ...
              <FontPicker
                font={fontFamily[0]}
                onChange={f =>
                  onUpdateSettings({ fontFamily: [f, fontFamily[1]] })
                }
              />
            </Form.Field>
          </Grid.Column>
          <Grid.Column width={6}>
            <Form.Field>
              ...
              <FontPicker
                font={fontFamily[1]}
                onChange={f =>
                  onUpdateSettings({ fontFamily: [fontFamily[0], f] })
                }
              />
            </Form.Field>
          </Grid.Column>
          ...
          <Grid.Column width={7}>
            <Form.Field>
              ...
              <Slider
                ...
                value={fontSize}
                onChange={size => onUpdateSettings({ fontSize: size })}
              />
            </Form.Field>
          </Grid.Column>
          <Grid.Column width={5}>
            <Form.Field>
              ...
              <Slider
                ...
                value={lineHeight}
                onChange={size => onUpdateSettings({ lineHeight: size })}
              />
            </Form.Field>
          </Grid.Column>
          <Grid.Column width={4}>
            <Form.Field>
              ...
              <Slider
                ...
                className="spacing-slider"
                value={letterSpacing}
                onChange={size => onUpdateSettings({ letterSpacing: size })}
              />
            </Form.Field>
          </Grid.Column>
        </Grid>
        ...
        <Grid>
          <Grid.Column width={5}>
            <Form.Field inline>
              ...
              <ColorPicker
                color={color}
                onChange={color => onUpdateSettings({ color: color.hex })}
              />
            </Form.Field>
          </Grid.Column>
          <Grid.Column width={6}>
            <Form.Field inline>
              ...
              <ColorPicker
                color={linkColor}
                onChange={color => onUpdateSettings({ linkColor: color.hex })}
              />
              <Button
                icon="underline"
                size="small"
                ...
                onClick={e => {
                  ...
                  onUpdateSettings({
                    linkUnerline:
                      linkUnerline === 'underline' ? 'none' : 'underline',
                  });
                }}
              />
            </Form.Field>
          ...
          <Grid.Column width={5}>
            <Form.Field inline>
              ...
              <ColorPicker
                ...
                onChange={color =>
                  onUpdateSettings({ backgroundColor: color.hex })
                }
              />
            </Form.Field>
          </Grid.Column>
      ...
      <Segment>
        <PreviewBox
          {...{
            ...
            lineHeight,
            letterSpacing,
            link: { color: linkColor, textDecoration: linkUnerline },
          }}
        />
      </Segment>
    </Segment.Group>
...
const Behavior = ({
  show,
  onUpdateSettings,
  settings: { isTocOpen, isTocPinned },
}) => (
...
const { reader, showSettings, globals, onUpdateSettings, onClose } = this.props;
