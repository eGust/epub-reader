...
// shelf
export const OPEN_BOOK_FILES = 'OPEN_BOOK_FILES';
export const UPDATE_SHELF_BOOKS = 'UPDATE_SHELF_BOOKS';
  ...
  (dispatch, getState) => {
    ...
    Api.openBook(book, (bookInfo) => {
      ...
      Api.onClientReady(() => {
        ...
        const {
          chapterPath = null, pageNo = null, pageCount = null,
        } = bookInfo.progress || {}
        if (chapterPath && chapterPath.length) {
          ...
          Api.queryDocRoot(bookInfo.book.id, ({
            href: chapterPath,
          }) => {
      ...
      Api.onUpdateProgress(({
        ...
        const oldBooks = getState().shelf.books
...
export const updateSorting = (order) => (
  (dispatch, getState) => {
    ...
    Api.saveSettings('shelf.sorting', { ...getState().shelf.sorting,
      ...order,
    })
  }
)
...
// reader
export const TOGGLE_TOC_PIN = 'TOGGLE_TOC_PIN';
export const TOGGLE_TOC_OPEN = 'TOGGLE_TOC_OPEN';
export const TOGGLE_TOC_ITEM_OPEN = 'TOGGLE_TOC_ITEM_OPEN';
export const CHANGE_CURRENT_BOOK = 'CHANGE_CURRENT_BOOK';
export const CHANGE_READER_CONTENT_PATH = 'CHANGE_READER_CONTENT_PATH';
export const UPDATE_READER_PROGRESS = 'UPDATE_READER_PROGRESS'
...
export const doChangeReaderPage = ({
  book,
  progress,
  delta,
}) => {
